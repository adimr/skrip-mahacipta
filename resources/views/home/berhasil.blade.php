            ...
            <div class="col-lg-12 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
                <div class="kotak">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <p class="text-right">
                                <a href="{{ asset('cetak/' . $pemesanan->token_transaksi) }}"
                                    class="btn btn-danger btn-sm" target="_blank">
                                    <i class="fa fa-file-pdf"></i> Cetak Bukti Pemesanan
                                </a>
                            </p>

                            <p>Hai <strong><?php echo $pemesanan->nama_pemesan; ?></strong>, berikut adalah data pesanan Anda. Kami akan
                                segera memproses data pesanan tersebut.</p>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Jumlah</td>
                                        <td>:</td>
                                        <td><?php echo $pemesanan->jumlah_produk; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Harga Produk</td>
                                        <td>:</td>
                            ...
                            <hr>
                            <p class="text-center"><button class="btn btn-success" id="proses">Proses
                                    Pembayaran</button>
                                <a class="btn btn-primary" role="button" href="{{ asset('produk') }}">Melihat Produk
                                    Lainnya</a>
                            </p>
                        </div>
                    </div>
