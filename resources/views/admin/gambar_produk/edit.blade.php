<p class="text-right">
    <a href="{{ asset('admin/produk/gambar_produk/' . $gambar->id_produk) }}" class="btn btn-success btn-sm"><i
            class="fa fa-backward"></i> Kembali</a>
</p>
<hr>


<form action="{{ asset('admin/produk/edit_gambar_produk') }}" method="post" enctype="multipart/form-data"
    ...
    <div class=" form-group">
        ...
        <br>
        <div class="col-md-9"><img src="{{ asset('public/upload/image/thumbs/' . $gambar->gambar) }}" width="180"
                class="img img-responsive"></div><br>
        <div class="col-md-9">
    ...
    <div class=" form-group">
        ...
        <div class="col-md-9">
            <input type="text" name="nama_gambar_produk" class="form-control" placeholder="Judul gambar"
                value="{{ $gambar->nama_gambar_produk }}">
        </div>
    </div>
