    ...
    <div class="col-md-6">
        <form action="{{ asset('admin/pemesanan/cari') }}" method="get" accept-charset="utf-8">
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="keywords" value="<?php if (isset($_GET['keywords'])) {
                    echo $_GET['keywords'];
                } ?>" placeholder="Cari..."
                    required>
...
<form action="{{ asset('admin/pemesanan/proses') }}" method="post" accept-charset="utf-8">
    ...
    <div class="row">
        <div class="input-group mb-3 col-md-4">
            ...
            <select name="status_pemesanan" class="form-control">
                ...
                <option value="Dibatalkan">Dibuat</option>
                <option value="Konfirmasi">Konfirmasi</option>a
            </select>
            <span class="input-group-append">
  ...
  ?>
                ...
                <tr>
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_pemesanan[]" value="<?php echo $pemesanan->id_pemesanan; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        ...
                        ?>
                        <a href="{{ asset('admin/pemesanan/status_pemesanan/' . $pemesanan->status_pemesanan) }}"
                            class="btn btn-sm btn-block {{ $class }}">
                    ...
                    <td><?php if($pemesanan->nama_produk=="") { echo '<div class="alert alert-warning text-center"><i class="fa fa-times"></i><br>Produk tidak tersedia</div>'; }else{ ?>
                        ...
                        <small>
                            ...
                            <br><img src="{{ asset('public/upload/image/thumbs/' . $pemesanan->gambar) }}"
                    ...
                    <td>
                        <small>
                            <i class="fas fa-shopping-cart"></i> Produk Yang Dipesan: <?php echo $pemesanan->jumlah_produk; ?>
        ...
        <a href="{{ asset('admin/pemesanan/edit/'.$pemesanan->id_pemesanan) }}" class="btn btn-success btn-block btn-sm"><i class="fa fa-check"></i> Update Status</a>
                        ...
                        <div class="btn-group">
                            <a href="{{ asset('admin/pemesanan/detail/' . $pemesanan->id_pemesanan) }}"
                                class="btn btn-secondary btn-sm" target="_blank"><i class="fa fa-eye"></i></a>
                            <a href="{{ asset('admin/pemesanan/cetak/' . $pemesanan->id_pemesanan) }}"
                                class="btn btn-info btn-sm" target="_blank"><i class="fa fa-print"></i></a>
                            <a href="{{ asset('admin/pemesanan/delete/' . $pemesanan->id_pemesanan) }}"
