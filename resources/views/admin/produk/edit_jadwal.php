...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <select name="status_jadwal_produk" class="form-control select2">
            ...
            <option value="Tutup" <?php if ($jadwal_produk->status_jadwal_produk == "Tutup") {
                                        echo "selected";
                                    } ?>>Tutup</option>
            <option value="Booked" <?php if ($jadwal_produk->status_jadwal_produk == "Booked") {
                                        echo "selected";
                                    } ?>>Sudah dibooking (Booked)</option>
            <option value="Batal" <?php if ($jadwal_produk->status_jadwal_produk == "Batal") {
                                        echo "selected";
                                    } ?>>Batal</option>
        </select>
    </div>
    ...
    <div class="col-sm-9">
        <select name="id_lokasi" class="form-control select2">
            <?php foreach ($lokasi as $lokasi) { ?>
                <option value="<?php echo $lokasi->id_lokasi ?>" <?php if ($jadwal_produk->id_lokasi == $lokasi->id_lokasi) {
                                                                        echo "selected";
                                                                    } ?>>
