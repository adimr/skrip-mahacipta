        ...
        <form action="{{ asset('admin/produk/cari') }}" method="get" accept-charset="utf-8">
            ...
            <div class="input-group">
                <input type="text" name="keywords" class="form-control"
                    placeholder="Ketik kata kunci pencarian produk...." value="<?php if (isset($_GET['keywords'])) {
            ...
            <tbody>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><a href="{{ asset('admin/produk/kategori/' . $produk->id_kategori_produk) }}">
                        ...
                        <br><small><?php echo $produk->deskripsi; ?></small>
                    </td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="{{ asset('admin/produk/gambar_produk/' . $produk->id_produk) }}"
                                class="btn btn-success btn-sm"><i class="fa fa-image"></i> </a>

                            <a class="btn btn-info btn-sm" href="{{ asset('produk/detail/' . $produk->slug_produk) }}"
